...
public class Schnorr{
	...
	public static Schnorr fromCertificate(String json){
		...
		schnorr.setG((new BigInteger(jsonObject.getString("q"))));
		schnorr.setQ((new BigInteger(jsonObject.getString("g"))));
	...
	public static Schnorr fromParameters(String[] params){
		...
		schnorr.setG((new BigInteger(params[1])));
		schnorr.setQ((new BigInteger(params[2])));
		schnorr.setY((new BigInteger(params[3])));
		schnorr.setX((new BigInteger(params[4])));
